...
public class AWSUCLADiningHallClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "AWSUCLADiningHallClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:AWSUCLADiningHallClient = {
        ...
        return AWSUCLADiningHallClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = AWSUCLADiningHallClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `AWSUCLADiningHallClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> AWSUCLADiningHallClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         AWSUCLADiningHallClient.registerClient(withConfiguration: configuration, forKey: "USWest2AWSUCLADiningHallClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = AWSUCLADiningHallClient.client(forKey: "USWest2AWSUCLADiningHallClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(AWSUCLADiningHallClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> AWSUCLADiningHallClient {
		objc_sync_enter(self)
		if let client: AWSUCLADiningHallClient = _serviceClients.object(forKey: key) as? AWSUCLADiningHallClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			AWSUCLADiningHallClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! AWSUCLADiningHallClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://i5bka3jah1.execute-api.us-west-1.amazonaws.com/prod"
